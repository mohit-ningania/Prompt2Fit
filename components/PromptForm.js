      ...
      <div className="glass group relative rounded-3xl p-2 shadow-[0_20px_60px_-25px_rgba(0,0,0,0.6)] transition-colors focus-within:border-accent/40">
        ...
        <div className="flex items-center justify-between px-4 pb-2 pt-1">
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-full bg-gradient-to-r from-accent to-accent-2 px-5 py-2.5 text-sm font-medium text-[#1a1305] transition-transform enabled:hover:scale-[1.03] disabled:cursor-not-allowed disabled:opacity-40"
          >
            {loading ? (
              <>
